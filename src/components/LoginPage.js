  ...
  return (
    ...
    >
      ...
      <Typography
        ...
        style={{ padding: "10px" }}
      >
        Listen to unlimited songs without any ads for free only on sahirat Music Web App 
      </Typography>
      <h1 style={{fontFamily:"cursive"}}>Hand Crafted by Sahil</h1>
      <Button variant="outlined" style={{ color: "#070C3B " }} onClick={continueToHome}>
        Continue
        <NavigateNext />
      </Button>
    </Grid>
